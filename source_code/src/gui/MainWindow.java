...
public class MainWindow extends JFrame {
    ...
    public MainWindow(String scenName, World world, PlayField field,
        ...
        // Had to switch this to the BorderLayout or the InfoPanel 
        // would be too short to read the text
        ...
        leftPane.add(guiControls, BorderLayout.NORTH);
        leftPane.add(playFieldScroll, BorderLayout.CENTER);
        leftPane.add(new JScrollPane(infoPanel), BorderLayout.SOUTH);
