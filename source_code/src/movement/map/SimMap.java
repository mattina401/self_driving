...
public class SimMap implements Serializable {
	...
	/** maps Coord to MapNodes with sorted Coord keys */
	...
	/**
	 * Returns a map of the sorted coords mapped to map nodes in a list
	 * @return a map of the sorted coords mapped to map nodes in a list
	 */
	public Map<Coord, MapNode> getMappedNodes() {
